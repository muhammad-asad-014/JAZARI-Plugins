...
def home():
    ...
    return render_template('presenta-home.html', data=prev_rec, record_folder = records_folder, active_data=active_notes)
...
def update_settings():
    ...
    if request.method=='POST':
        ...
        return redirect(url_for('presenta.update_settings'))
    return render_template('presenta-settings.html')
